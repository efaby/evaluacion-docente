...
CREATE TABLE `matricula` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_matricula_usuario1` (`usuario_id`),
  ...
  CONSTRAINT `fk_matricula_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `matricula_evaluacion` (
  ...
  `evaluacion_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_matricula_evaluacion_matricula1` (`matricula_id`),
...
CREATE TABLE `respuesta_evaluacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_respuesta_evaluacion_matricula_evaluacion1` (`matricula_evaluacion_id`),
  KEY `fk_respuesta_evaluacion_respuesta1` (`respuesta_id`),
  CONSTRAINT `fk_respuesta_evaluacion_matricula_evaluacion1` FOREIGN KEY (`matricula_evaluacion_id`) REFERENCES `matricula_evaluacion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
